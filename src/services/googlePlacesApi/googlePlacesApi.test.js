describe('googlePlacesApi', () => {
  test('fetchGooglePlaces', async () => {
    ...
    const googlePlacesApi = require('./googlePlacesApi');
    const expectedUrl = googlePlacesApi.URL;
    const expectedTypes = googlePlacesApi.TYPES;
    ...
    // act
    const actualResult = await googlePlacesApi.fetchGooglePlaces(expectedCity);
    // assert
    expect(mockAxios.get).toHaveBeenCalledWith(expectedUrl, expectedParams);
